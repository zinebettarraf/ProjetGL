...
public class IMAProgram {
    ...
    public void addARMComment(String s) {
        Line armc = new Line(s);
        armc.setArmComment(true);
        lines.add(armc);
    }

    public void addDirective(Directive dir) {
        lines.add(new Line(dir));
    }
    ...
    public void addARMInstruction(Instruction i, String s) {
        Line armc = new Line(null, i, s);
        armc.setArmComment(true);
        lines.add(armc);
    }
